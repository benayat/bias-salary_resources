...
# Sample the dataset
#uv run scripts/h1b_dataset/sample_dataset.py --input data/h1b-lca-disclosure-data-2020-2024/Combined_LCA_Disclosure_Data_FY2024.csv --ai-titles data/h1b-lca-disclosure-data-2020-2024/ai_ml_job_titles.csv --output data/h1b-lca-disclosure-data-2020-2024/h1b_2024_sampled-1000_block_balanced.csv --seed 42 --target-total 200 --seed 42 --max-pairs-per-soc 5 --ai-soc-weight-mode sqrt
...
#    uv run scripts/h1b_dataset/estimate_h1b_salaries.py --model "$model" --client-type openai --openai-api-key crap --openai-base-url http://localhost:8000/v1 --input-csv-file data/h1b-lca-disclosure-data-2020-2024/h1b_2024_sampled-1000_block_balanced.csv
#done
