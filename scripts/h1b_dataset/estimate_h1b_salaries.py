...
def main():
    ...
    if args.client_type == "openai":
        ...
        sampling_params = OpenAISamplingConfig(temperature=0.0, top_p=1.0, max_tokens=512) if "gpt-oss" in args.model else OpenAISamplingConfig(temperature=0.0, top_p=1.0, max_tokens=16)
    else:
